  ...
  return (
    <div className="p-8 flex flex-col gap-3">
      <div>
        ...
        <p>Welcome to pet-a-pet (the &quot;App&quot;), a mobile application designed to connect pet owners and people who love animals in general, facilitate pet adoptions of rescues and sheltered pets, and help organize meetups and events.</p>
      ...
      <div className="mt-2 flex flex-col gap-3">
        ...
        <div>
          <p>C. Communications and User-Generated Content</p>
          <ul className="list-disc list-inside">
